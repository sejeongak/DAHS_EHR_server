...
# EXP_NAME="multitask_mlm3030305epoch30_lr5e-5cfweght4_dropout0.3_cosinescheduler_window24_attentionpooling_onelayer_gap_fold0_SEED42_orderdescriptionablation"
EXP_NAME="mimic_final_inference_48_SEED42_fold2"
Load_EXP_NAME="multitask_mlm3030305epoch30_lr5e-5cfweight4_dropout0.3_cosinescheduler_window24_attentionpooling_onelayer_gap_fold2_SEED42"
# EXP_NAME="TEST"
...
torchrun --nproc_per_node=1 finetune_normal.py \
  --num_hidden_layers 6 \
